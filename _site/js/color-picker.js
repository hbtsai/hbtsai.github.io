var colorPickerModule = (function() {
  'use strict';
  var colorArray = [{"name":"Black","value":"#4A4A4A"},{"name":"Brown","value":"#B47239"},{"name":"Red","value":"#D0021B"},{"name":"Orange","value":"#F5A623"},{"name":"White","value":"#FFF"},{"name":"Purple","value":"#9013FE"},{"name":"Yellow","value":"#F8E71C"},{"name":"Green","value":"#008100"},{"name":"Blue","value":"#0000FF"},{"name":"Grey","value":"#808080"}];
  var cableArray = [{"name":"A","color":"Brown"},{"name":"B","color":"Orange"},{"name":"C","color":"Yellow"},{"name":"N","color":"White"}];
  var selectedCable = cableArray[0].name;
  var selectedPanel = "three";
