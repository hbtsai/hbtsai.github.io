...
var selectModule = (function() {
  'use strict';
  var selections = {
    "panel-type": "{{ site.data.state.panelType }}",
    "panel-voltage": "{{ site.data.state.panelVoltage }}",
    "small-ct": "{{ site.data.state.smallCT }}",
    "large-ct": "{{ site.data.state.largeCT }}",
    "mounting-location": "{{ site.data.state.mountingLocation }}",
    "breakers": "{{ site.data.state.breakers }}",
    "chains": "{{ site.data.state.chains }}",  
    "confirmation": "{{ site.data.state.confirmation }}", 
    "errorType": "{{ site.data.state.errorType }}",
    "error-light": "{{ site.data.state.errorLight }}", 
    "error-light-selector": "{{ site.data.state.errorLightSelector }}", 
    "error-fix-selector": "{{ site.data.state.errorFixSelector }}"
  };
